...
export default async function Dataset(props: { params: paramsType }) {
    ...
    return (
        ...
        <main>
            <div className="max-w-screen-2xl mx-auto border-l border-r border-l-border border-r-border">

                {/* Article Header */}
                <section className="space-y-20  p-20">
                    {/* Back Button */}
                    ...
                    <div>
                        <h1 className="text-4xl lg:text-8xl lg:max-w-4xl font-light text-foreground leading-24 mb-8">
                            {dataset.title}
                        </h1>
                        ...
                        <div className="flex justify-between mt-9">
                            <div className="flex gap-2">
                                {badges && badges.map((badge, idx) => (
                                    <Badge variant="secondary" key={idx}>{badge}</Badge>
                                )
                            ...
                            <div className="flex gap-4">
                                {ctas && ctas.map((cta, idx) => (
                                    <Button variant="outline" key={idx}><a href={cta.url}>{cta.label}</a></Button>
                                )
                    ...
                    <div className="bg-muted flex justify-center items-center p-10 min-h-[500px] text-muted-foreground">{dataset.hero}</div>
                </section>
