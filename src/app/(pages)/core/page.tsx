...
import FeatureComponent from "@/components/featureSlice";
      ...
      <section className="border-t border-t-border">
        <div className="max-w-screen-2xl justify-center mx-auto p-10 lg:p-20 border-l border-r border-l-border border-r-border">
          ...
          <div className="grid grid-cols-3 gap-20">
           ...
           <ImagePlaceholder className="col-span-2 aspect-video"/>
          </div>
        </div>
        <div className="max-w-screen-2xl justify-center mx-auto p-10 lg:p-20 border-l border-r border-l-border border-r-border">
         <FeatureComponent />
        ...
        <div className="max-w-screen-2xl mx-auto p-20 border-l border-r border-l-border border-r-border space-y-20">
          <div className="grid md:grid-cols-2 gap-20">
            ...
            <div>
              ...
              <Button><a href="/core/data-management">Learn more</a></Button>
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-20">
            <ImagePlaceholder className="aspect-video"/>
            <div>
              ...
              <Button><a href="/core/training">Learn more</a></Button>
            </div>
          </div>
          <div className="grid md:grid-cols-2 gap-20">
            <ImagePlaceholder className="aspect-video"/>
            <div>
              ...
              <Button><a href="/core/inference">Learn more</a></Button>
            </div>
          </div>
        </div>
      </section>
